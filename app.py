...
#         st.session_state.input_text = "URGENT! Work from home. Earn 1.5 lakh/month. No experience needed. WhatsApp 9876543210. Registration fee 500rs refundable. hrjobs2024@gmail.com"

# with col2:
#     if st.button("🟢 Legit Example"):
#         st.session_state.input_text = "TCS hiring 2024 batch. Associate Software Engineer. Package 3.36 LPA. Apply at careers.tcs.com. Last date 30th May 2024."

# with col3:
#     if st.button("🟡 Suspicious Example"):
#         st.session_state.input_text = "BPO hiring freshers. Salary 25000/month. Night shift US process. No experience. Join: bpohiring99@gmail.com"
